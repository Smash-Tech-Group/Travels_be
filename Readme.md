...
**Cloning**
- clone the repository using `git clone https://github.com/Smash-Tech-Group/Travels_be`
- `cd` into the directory Travels_python_fastapi_web
...
CREATE DATABASE travels_api;
GRANT ALL PRIVILEGES ON DATABASE travels_api TO user;
```
